...
def invalid_type_error():
    message = print('Improper Data Type Used')
    return(message)
...
def validate_and_execute_calc():
    try:
        ...
        invalid_type_error()
    except TypeError: # Used to stop errors related to list ranges
        invalid_type_error()
...
while user_input != terminate_program:
    ...
    try:
        ...
        jiffy_and_new_unit_dictionary = {"jiffy": jiffy_and_new_unit[0], "unit": jiffy_and_new_unit[1]} # Dictonary 
