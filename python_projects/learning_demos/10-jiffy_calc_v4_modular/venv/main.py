from validate_and_execute import calc_jiffy_convert, validate_and_execute_calc
...
while user_input != terminate_program:
    ...
    try:
        ...
        jiffy_and_new_unit_dictionary = {"jiffy": jiffy_and_new_unit[0], "unit": jiffy_and_new_unit[1]}
